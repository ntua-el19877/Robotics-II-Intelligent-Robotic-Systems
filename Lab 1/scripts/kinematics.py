...
class xArm7_kinematics():
    ...
    def tf_A02(self, r_joints_array):
        ...
        tf_A12= np.matrix([[c2 , -s2 , 0 , 0],\
                          ...
                          [-s2 , -c2 , 0 , 0],\
                          [0   ,  0  , 0 , 1]])
        tf = self.tf_A01(r_joints_array)@tf_A12 
        return tf
    ...
    def tf_A03(self, r_joints_array):
        ...
        tf_A23 = np.matrix([[c3 , -s3 ,  0 ,  0],\
                           ...
                           [s3  ,  c3 ,  0 ,  0],\
                           [0   ,  0  ,  0 ,  1]])
        tf = self.tf_A02(r_joints_array)@tf_A23 
        return tf
    ...
    def tf_A04(self, r_joints_array):
        ...
        tf = self.tf_A03(r_joints_array)@tf_A34 
        return tf
    ...
    def tf_A05(self, r_joints_array):
        ...
        tf_A45 = np.matrix([[c5 , -s5 , 0 ,  x],\
                           ...
                           [ s5 ,  c5 , 0 ,  0],\
                           [0   ,  0  , 0 ,  1]])
        tf = self.tf_A04(r_joints_array)@tf_A45
        return tf
    ...
    def tf_A06(self, r_joints_array):
        ...
        tf_A56 = np.matrix([[c6 , -s6 ,  0 ,  0],\
                           ...
                           [s6  ,  c6 ,  0 ,  0],\
                           [0   ,  0  ,  0 ,  1]])
        tf = self.tf_A05(r_joints_array)@tf_A56 
        return tf
    ...
    def tf_A07(self, r_joints_array):
        ...
        tf_A67 = np.matrix([[c7 , -s7 , 0 ,  z],\
                           ...
                           [-s7 , -c7 , 0 ,  0],\
                           [0   ,  0  , 0 ,  1]])
        tf = self.tf_A06(r_joints_array)@tf_A67 
        return tf
